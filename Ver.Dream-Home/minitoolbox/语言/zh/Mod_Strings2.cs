...
namespace minitoolbox
{
    public static class STRINGS2
    {
        ...
        public static LocString 电池配置 = "电池配置";
        public static LocString 功率配置 = "功率配置";
        public static LocString 自定义配方区 = "自定义配方区";
        ...
        public static LocString 自定义配方 = "自定义配方";
    ...
    public static class 建筑2
    {
        ...
        {
            public static LocString 功率 = "碎石机消耗的电力";
            public static LocString 发热 = "碎石机不会发热";
            public static LocString 淹没 = "碎石机不会被淹没";
            public static LocString 过热 = "碎石机不会过热";
            public static LocString 操作 = "碎石机不需要复制人去操作";
        }
        ...
        {
            public static LocString 发热 = "变压器不会发热";
        }
        public static class 大型变压器
        {
            public static LocString 发热 = "大型变压器不会发热";
        }
