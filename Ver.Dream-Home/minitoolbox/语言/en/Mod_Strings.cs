...
namespace minitoolbox
{
    public static class STRINGS1
    {
        ...
        public static LocString 自定义配方区 = "Custom Recipe";
    ...
    public static class 建筑
    {
        ...
        {
            public static LocString 功率 = "RockCrusher Power consumption";
            public static LocString 发热 = "RockCrusher does not generate heat";
            public static LocString 淹没 = "RockCrusher Won't be submerged";
            public static LocString 过热 = "RockCrusher Not overheat";
            public static LocString 操作 = "RockCrusher No operation required";
        }
