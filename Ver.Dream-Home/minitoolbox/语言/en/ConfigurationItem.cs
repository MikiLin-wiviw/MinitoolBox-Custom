...
namespace minitoolbox
{
    ...
    public class ConfigurationItem : SingletonOptions<ConfigurationItem>
    {
        ...
        //________________________________________________________________________________________
        [Option("minitoolbox.建筑.电池.漏电", "", "minitoolbox.STRINGS.电池配置", Format = "F0")]
        [JsonProperty]
        public bool 电池漏电 { get; set; }

        [Option("minitoolbox.建筑.电池.容量", "", "minitoolbox.STRINGS.电池配置", Format = "F1")]
        [Limit(10, 100000.0)]
        [JsonProperty]
        public float 电池容量 { get; set; }

        //________________________________________________________________________________________
        [Option("minitoolbox.建筑.巨型电池.漏电", "", "minitoolbox.STRINGS.电池配置", Format = "F0")]
        [JsonProperty]
        public bool 巨型电池漏电 { get; set; }

        [Option("minitoolbox.建筑.巨型电池.容量", "", "minitoolbox.STRINGS.电池配置", Format = "F1")]
        [Limit(40, 2000000.0)]
        [JsonProperty]
        public float 巨型电池容量 { get; set; }

        //________________________________________________________________________________________
        [Option("minitoolbox.建筑.智能电池.漏电", "", "minitoolbox.STRINGS.电池配置", Format = "F0")]
        [JsonProperty]
        public bool 智能电池漏电 { get; set; }

        [Option("minitoolbox.建筑.智能电池.容量", "", "minitoolbox.STRINGS.电池配置", Format = "F1")]
        [Limit(20, 4000000.0)]
        [JsonProperty]
        public float 智能电池容量 { get; set; }

        //________________________________________________________________________________________
        [Option("minitoolbox.建筑.电池舱.漏电", "", "minitoolbox.STRINGS.电池配置", Format = "F0")]
        [JsonProperty]
        public bool 电池舱漏电 { get; set; }

        [Option("minitoolbox.建筑.电池舱.容量", "", "minitoolbox.STRINGS.电池配置", Format = "F1")]
        [Limit(100, 6000000.0)]
        [JsonProperty]
        ...
        [Option("minitoolbox.建筑.金属精炼器.追加自定义配方", "", "minitoolbox.STRINGS.自定义配方", Format = "F0")]
        [JsonProperty]
        ...
        //________________________________________________________________________________________
        [Option("minitoolbox.建筑.碎石机.容量", " ", "minitoolbox.STRINGS.容量配置", Format = "F0")]
        [Limit(800, 4000)]
        [JsonProperty]
        ...
        [Option("minitoolbox.建筑.碎石机.追加自定义配方", "", "minitoolbox.STRINGS.自定义配方", Format = "F0")]
        [JsonProperty]
        ...
        [Option("minitoolbox.建筑.碎石机.淹没", "", "minitoolbox.STRINGS.建筑淹没配置", Format = "F0")]
        [JsonProperty]
        public bool RockCrusher_Submerge { get; set; }

        [Option("minitoolbox.建筑.碎石机.过热", "", "minitoolbox.STRINGS.建筑过热配置", Format = "F0")]
        [JsonProperty]
        public bool RockCrusher_Overheat { get; set; }

        [Option("minitoolbox.建筑.碎石机.操作", "", "minitoolbox.STRINGS.人力操作", Format = "F0")]
        [JsonProperty]
        ...
        //________________________________________________________________________________________
        [Option("minitoolbox.建筑.变压器.发热", "", "minitoolbox.STRINGS.建筑自热配置", Format = "F0")]
        [JsonProperty]
        public bool PowerTransformerSmall_SelfHeating { get; set; }

        [Option("minitoolbox.建筑.大型变压器.发热", "", "minitoolbox.STRINGS.建筑自热配置", Format = "F0")]
        [JsonProperty]
        ...
        public ConfigurationItem()
        {
            ...
            this.GasPump_Electricity = 240f;//气泵功率
            this.GasPump_SelfHeating = false;//气泵自热
            this.GasPump_Overheat = false;//气泵过热
