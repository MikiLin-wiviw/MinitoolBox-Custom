...
namespace minitoolbox.建筑配置项.碎石机
{
    ...
    public class RockCrusher
    {
        ...
        {
            //碎石机追加自定义配方
            if (SingletonOptions<ConfigurationItem>.Instance.RockCrusher_CustomRecipe && ElementLoader.FindElementByHash(SimHashes.MaficRock) != null)
            {
                float num = 0.9f;
            ...
            //是否需要复制人去操作
            go.AddOrGet<ComplexFabricator>().duplicantOperated = 碎石机.操作;
        }
    }
}
