...
namespace minitoolbox
{
    ...
    public class ConfigurationItem : SingletonOptions<ConfigurationItem>
    {
        ...
        [Option("minitoolbox.建筑.智能储物箱.容量", "", "minitoolbox.STRINGS.容量配置", Format = "F0")]
        [Limit(2000.0, 10000000.0)]
        [JsonProperty]
        public float StorageBoxSmart_Capacity { get; set; }
        ...
        //________________________________________________________________________________________
        [Option("minitoolbox.建筑.气泵.功率", "", "minitoolbox.STRINGS.功率配置", Format = "F0")]
        [Limit(1, 240)]
        [JsonProperty]
        public float GasPump_Electricity { get; set; }

        [Option("minitoolbox.建筑.气泵.发热", "", "minitoolbox.STRINGS.建筑自热配置", Format = "F0")]
        [JsonProperty]
        public bool GasPump_SelfHeating { get; set; }

        [Option("minitoolbox.建筑.气泵.过热", "", "minitoolbox.STRINGS.建筑过热配置", Format = "F0")]
        [JsonProperty]
        public bool GasPump_Overheat { get; set; }


        //________________________________________________________________________________________
        [Option("minitoolbox.建筑.金属精炼器.配方", "", null, Format = "F0")]
        [JsonProperty]
        public bool MetalRefinery_Recipe { get; set; }

        //________________________________________________________________________________________
        [Option("minitoolbox.建筑.普通电池.容量", "", "minitoolbox.STRINGS.容量配置", Format = "F1")]
        [Limit(100, 500000.0)]
        [JsonProperty]
        public float BatteryNormal_Capacity { get; set; }

        [Option("minitoolbox.建筑.普通电池.漏电", "", null, Format = "F0")]
        [JsonProperty]
        public bool BatteryNormal_Loss { get; set; }


        //________________________________________________________________________________________
        [Option("minitoolbox.建筑.巨型电池.容量", "", "minitoolbox.STRINGS.容量配置", Format = "F1")]
        [Limit(100, 500000.0)]
        [JsonProperty]
        public float BatteryLarge_Capacity { get; set; }

        [Option("minitoolbox.建筑.巨型电池.漏电", "", null, Format = "F0")]
        [JsonProperty]
        public bool BatteryLarge_Loss { get; set; }


        //________________________________________________________________________________________
        [Option("minitoolbox.建筑.智能电池.容量", "", "minitoolbox.STRINGS.容量配置", Format = "F1")]
        [Limit(100, 500000.0)]
        [JsonProperty]
        public float BatterySmart_Capacity { get; set; }

        [Option("minitoolbox.建筑.智能电池.漏电", "", null, Format = "F0")]
        [JsonProperty]
        public bool BatterySmart_Loss { get; set; }


        //________________________________________________________________________________________
        [Option("minitoolbox.建筑.聚合物压塑器.用水", "", null, Format = "F0")]
        [JsonProperty]
        public bool Polymerizer_Water { get; set; }

        [Option("minitoolbox.建筑.聚合物压塑器.用水量", "", "minitoolbox.STRINGS.用量配置",Format = "F0")]
        [JsonProperty]
        public float Polymerizer_WaterUse { get; set; }
        [Limit(0.1, 0.833)]

        [Option("minitoolbox.建筑.聚合物压塑器.塑料产量", "", "minitoolbox.STRINGS.排放配置")]
        [JsonProperty]
        public float Polymerizer_PolypropyleneOutput { get; set; }
        [Limit(0.5, 10)]


        //________________________________________________________________________________________

        [Option("minitoolbox.建筑.碎石机.淹没", "", "minitoolbox.STRINGS.建筑淹没配置")]
        [JsonProperty]
        public bool RockCrusher_Submerge { get; set; }

        [Option("minitoolbox.建筑.碎石机.过热", "", "minitoolbox.STRINGS.建筑过热配置")]
        [JsonProperty]
        public bool RockCrusher_Overheat { get; set; }

        [Option("minitoolbox.建筑.碎石机.发热", "", "minitoolbox.STRINGS.建筑自热配置")]
        [JsonProperty]
        public bool RockCrusher_SelfHeating { get; set; }

        [Option("minitoolbox.建筑.碎石机.配方", "", "minitoolbox.STRINGS.建筑自热配置")]
        [JsonProperty]
        public bool RockCrusher_Recipe { get; set; }

        [Option("minitoolbox.建筑.碎石机.操作", "", "minitoolbox.STRINGS.人力操作")]
        [JsonProperty]
        public bool RockCrusher_Automatic { get; set; }

        [Option("minitoolbox.建筑.碎石机.功率", "", "minitoolbox.STRINGS.功率配置", Format = "F0")]
        [Limit(1, 1200)]
        [JsonProperty]
        public float RockCrusher_Electricity { get; set; }

        //________________________________________________________________________________________
        [Option("minitoolbox.建筑.藻类蒸馏器.藻类排放", "", "minitoolbox.STRINGS.排放配置", Format = "F0")]
        [Limit(200, 2000.0)]
        [JsonProperty]
        public float AlgaeVolume { get; set; }

        [Option("minitoolbox.建筑.藻类蒸馏器.污染水排放", "", "minitoolbox.STRINGS.排放配置", Format = "F0")]
        [Limit(200, 2000.0)]
        [JsonProperty]
        public float AlgaeDirtyWaterVolume { get; set; }


        //________________________________________________________________________________________
        [Option("minitoolbox.建筑.堆肥堆.污染土温度", "", "minitoolbox.STRINGS.排放配置", Format = "F0")]
        [Limit(0.0, 75.0)]
        [JsonProperty]
        public float Compost_Temperature { get; set; }
