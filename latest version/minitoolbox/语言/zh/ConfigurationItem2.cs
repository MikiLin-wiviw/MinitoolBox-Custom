...
namespace minitoolbox
{
    ...
    public class ConfigurationItem2 : SingletonOptions<ConfigurationItem2>
    {
        ...
        [Option("minitoolbox.建筑2.智能储物箱.容量", "", "minitoolbox.STRINGS2.容量配置", Format = "F0")]
        [Limit(2000.0, 10000000.0)]
        [JsonProperty]
        ...
        [Option("minitoolbox.建筑2.金属精炼器.配方", "", null, Format = "F0")]
        [JsonProperty]
        public bool MetalRefinery_Recipe { get; set; }


        [Option("minitoolbox.建筑2.普通电池.容量", "", "minitoolbox.STRINGS2.容量配置", Format = "F1")]
        [Limit(100, 500000.0)]
        [JsonProperty]
        public float BatteryNormal_Capacity { get; set; }

        [Option("minitoolbox.建筑2.普通电池.漏电", "", null, Format = "F0")]
        [JsonProperty]
        public bool BatteryNormal_Loss { get; set; }

        [Option("minitoolbox.建筑2.巨型电池.容量", "", "minitoolbox.STRINGS2.容量配置", Format = "F1")]
        [Limit(100, 500000.0)]
        [JsonProperty]
        public float BatteryLarge_Capacity { get; set; }

        [Option("minitoolbox.建筑2.巨型电池.漏电", "", null, Format = "F0")]
        [JsonProperty]
        public bool BatteryLarge_Loss { get; set; }

        [Option("minitoolbox.建筑2.智能电池.容量", "", "minitoolbox.STRINGS2.容量配置", Format = "F1")]
        [Limit(100, 500000.0)]
        [JsonProperty]
        public float BatterySmart_Capacity { get; set; }

        [Option("minitoolbox.建筑2.智能电池.漏电", "", null, Format = "F0")]
        [JsonProperty]
        public bool BatterySmart_Loss { get; set; }


        [Option("minitoolbox.建筑2.聚合物压塑器.用水", "", null, Format = "F0")]
        [JsonProperty]
        public bool Polymerizer_Water { get; set; }

        [Option("minitoolbox.建筑2.聚合物压塑器.用水量", "", "minitoolbox.STRINGS2.用量配置")]
        [Limit(0.1, 0.833)]
        [JsonProperty]
        public float Polymerizer_WaterUse { get; set; }

        [Option("minitoolbox.建筑2.聚合物压塑器.塑料产量", "", "minitoolbox.STRINGS2.排放配置")]
        [Limit(0.5, 10)]
        [JsonProperty]
        ...
        //________________________________________________________________________________________
        [Option("minitoolbox.建筑2.碎石机.淹没", "", "minitoolbox.STRINGS2.建筑淹没配置")]
        [JsonProperty]
        public bool RockCrusher_Submerge { get; set; }

        [Option("minitoolbox.建筑2.碎石机.过热", "", "minitoolbox.STRINGS2.建筑过热配置")]
        [JsonProperty]
        ...
        [Option("minitoolbox.建筑2.碎石机.配方", "", "minitoolbox.STRINGS2.建筑自热配置")]
        [JsonProperty]
        public bool RockCrusher_Recipe { get; set; }

        [Option("minitoolbox.建筑2.碎石机.操作", "", "minitoolbox.STRINGS2.人力操作")]
        [JsonProperty]
        ...
        //________________________________________________________________________________________
        [Option("minitoolbox.建筑2.藻类蒸馏器.藻类排放", "", "minitoolbox.STRINGS2.排放配置", Format = "F0")]
        [Limit(200, 2000.0)]
        [JsonProperty]
        public float AlgaeVolume { get; set; }

        [Option("minitoolbox.建筑2.藻类蒸馏器.污染水排放", "", "minitoolbox.STRINGS2.排放配置", Format = "F0")]
        [Limit(200, 2000.0)]
        [JsonProperty]
        public float AlgaeDirtyWaterVolume { get; set; }

        [Option("minitoolbox.建筑2.堆肥堆.污染土温度", "", "minitoolbox.STRINGS2.排放配置", Format = "F0")]
        [Limit(0.0, 75.0)]
        [JsonProperty]
